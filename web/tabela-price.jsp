<%-- 
    ...
    Created on : Mar 31, 2018, 7:44:22 PM
...
<!-- Formulario -->  
        ...
        <center><div class="col-sm-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-text pbody">Digite os dados solicitados a baixo para o cálculo da amortização pela Tabela Price.</p>
    ...
    <% try { %>
        ...
        <% }catch(Exception ex) { %> 
            ...
            <div class="container divOne"><center><p class="pbody">Dados inconsistentes</p>
                <p class="pbody">Por favor, usar pontos ao invés de vírgula</p>
